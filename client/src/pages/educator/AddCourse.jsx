      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
           ...
           py-2 w-28 px-3 rounded border border-gray-500"
            required
          />
        </div>
        ...
        <div>
          ...
          {showPopup && (
            ...
            >
              <div
                className="bg-white text-gray-700 p-4 rounded 
              ...
              >
                ...
                <div className="mb-2">
                  ...
                  <input
                    type="text"
                    className="mt-1 block w-full border rounded py-1
                     px-2"
